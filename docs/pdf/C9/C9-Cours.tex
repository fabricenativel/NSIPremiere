...
\begin{frame}
	...
	\begin{alertblock}{Algorithme du tri par sélection}
		\begin{itemize}
			\item<1-> Rechercher le plus petit élément de la liste
			\item<2-> Echanger cet élément avec le premier de la liste
			\item<3-> Recherche le second plus petit élément de la liste
...
\begin{frame}
	...
	\begin{exampleblock}{Exemple}
		...
		\begin{enumerate}
			\item<2->{Sélection du plus petit élément : \texttt{[12,\textcolor{red}{10},18,15,14]}}
			\item<3->{Placement en première position de liste : \texttt{[\textcolor{red}{10},12,18,15,14]}}
			\item<4->{Sélection du second plus petit élément : \texttt{[10,\textcolor{red}{12},18,15,14]}}
			\item<5->{Placement en deuxième position de liste: \texttt{[10,\textcolor{red}{12},18,15,14]}}
			\item<6->{Sélection du 3\textsuperscript{e} plus petit élément : \texttt{[10,12,18,15,\textcolor{red}{14}]}}
			\item<7->{Placement en 3\textsuperscript{e} de liste: \texttt{[10,12,\textcolor{red}{14},15,18]}}
			\item<8->{Sélection du 4\textsuperscript{e} plus petit élément : \texttt{[10,12,14,\textcolor{red}{15},18]}}
